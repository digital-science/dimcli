        ...
        'publications': {
            'fields': {
                ...
                'open_access_categories_v2': {
                    'type': 'string',
                    'description':
                    'Open Access categories for publications `(latest version) <https://www.dimensions.ai/wp-content/uploads/2021/02/Dimensions_New-OA-status-definition.pdf>`_',
                    'long_description':
            ...
            'search_fields': [
                'concepts', 'authors', 'title_only', 'title_abstract_only',
                'full_data_exact', 'full_data'
            ]
        },
        'grants': {
            'fields': {
