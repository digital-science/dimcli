...
GRAMMAR_DICT = {
    'sources': {
        'publications': {
            ...
            'search_fields': [
                'full_data', 'full_data_exact', 'authors', 'title_only',
        ...
        'grants': {
            ...
            'search_fields': [
                'full_data', 'investigators', 'title_only', 'concepts',
                'title_abstract_only'
            ]
        },
        'patents': {
            'fields': {
                ...
                'funder_groups': {
                    ...
                    'org_groups',
                    'description':
                    'Group of the organization that funded the patent.',
                    'long_description':
                    None,
                    'is_entity':
                    True,
            ...
            'search_fields':
            ['full_data', 'inventors', 'title_only', 'title_abstract_only']
        },
        'clinical_trials': {
            'fields': {
                'title': {
                ...
                'funder_groups': {
                    ...
                    'org_groups',
                    'description':
                    'The organisation group the funding organisations.',
                    'long_description':
                    None,
                    'is_entity':
                    True,
