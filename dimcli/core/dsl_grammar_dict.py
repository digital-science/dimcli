...
GRAMMAR_DICT = {
    'sources': {
        'publications': {
            ...
            'search_fields': [
                'title_abstract_only', 'concepts', 'noun_phrases', 'authors',
                'full_data_exact', 'full_data', 'title_only'
            ]
        },
        'grants': {
            'fields': {
            ...
            'search_fields': [
                'title_abstract_only', 'concepts', 'noun_phrases',
        ...
        'patents': {
            ...
            'search_fields':
            ['title_abstract_only', 'full_data', 'title_only', 'inventors']
        },
        'clinical_trials': {
            'fields': {
                'date': {
            ...
            'search_fields': [
                'title_abstract_only', 'full_data', 'investigators',
                'title_only'
            ]
        },
        'policy_documents': {
        ...
        'organizations': {
            'fields': {
                ...
                'ificlaims_ids': {
                    'type': 'string',
                    'description': 'IFI Claims IDs for this organization',
                    'long_description': None,
                    'is_entity': False,
                    'is_filter': True,
                    'is_facet': False
        ...
        'datasets': {
            ...
            'search_fields':
            ['title_abstract_only', 'full_data', 'title_only']
        }
    },
    'entities': {
        'categories': {
