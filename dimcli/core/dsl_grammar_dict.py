...
GRAMMAR_DICT = {
    'sources': {
        'publications': {
            ...
            'search_fields': [
                'title_abstract_only', 'authors', 'title_only',
                'full_data_exact', 'full_data', 'concepts'
            ]
        },
        'grants': {
            'fields': {
            ...
            'search_fields': [
                'title_abstract_only', 'investigators', 'title_only',
                'full_data', 'concepts'
            ]
        },
        'patents': {
            ...
            'search_fields':
            ['inventors', 'title_abstract_only', 'title_only', 'full_data']
        },
        'clinical_trials': {
            'fields': {
                'gender': {
