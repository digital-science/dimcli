...
GRAMMAR_DICT = {
    'sources': {
        'publications': {
            ...
            'search_fields': [
                'title_only', 'title_abstract_only', 'concepts', 'full_data',
                'full_data_exact', 'authors'
            ]
        },
        'grants': {
            'fields': {
            ...
            'search_fields': [
                'title_only', 'investigators', 'title_abstract_only',
                'concepts', 'full_data'
            ]
        },
        'patents': {
            ...
            'search_fields':
            ['inventors', 'title_only', 'full_data', 'title_abstract_only']
        },
        'clinical_trials': {
            'fields': {
                'funder_countries': {
