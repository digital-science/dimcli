...
GRAMMAR_DICT = {
    'sources': {
        'publications': {
            ...
            'search_fields': [
                'full_data_exact', 'authors', 'title_abstract_only',
                'full_data', 'concepts', 'title_only'
            ]
        },
        'grants': {
            'fields': {
        ...
        'patents': {
            ...
            'search_fields':
            ['full_data', 'inventors', 'title_abstract_only', 'title_only']
        },
        'clinical_trials': {
            'fields': {
                'active_years': {
            ...
            'search_fields': [
                'full_data', 'investigators', 'title_abstract_only',
                'title_only'
            ]
        },
        'policy_documents': {
        ...
        'datasets': {
            ...
            'search_fields':
            ['full_data', 'title_abstract_only', 'title_only']
        }
    },
    'entities': {
        'categories': {
